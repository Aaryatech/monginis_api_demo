...
public class TempItemList {
	...
	public String toString() {
		return "TempItemList [itemId=" + itemId + ", itemName=" + itemName + ", soldQty=" + soldQty + ", soldAmt="
				+ soldAmt + ", taxableAmt=" + taxableAmt + ", taxAmt=" + taxAmt + ", varQty=" + varQty + ", varAmt="
				+ varAmt + ", varTaxableAmt=" + varTaxableAmt + ", varTaxAmt=" + varTaxAmt + ", retQty=" + retQty
				+ ", retAmt=" + retAmt + ", retTaxableAmt=" + retTaxableAmt + ", retTaxAmt=" + retTaxAmt + "]";
	}
