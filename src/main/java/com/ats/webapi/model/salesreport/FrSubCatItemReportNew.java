...
@Entity
public class FrSubCatItemReportNew {
	...
	public String toString() {
		return "FrSubCatItemReportNew [crndId=" + crndId + ", itemId=" + itemId + ", itemName=" + itemName
				+ ", subCatId=" + subCatId + ", catId=" + catId + ", frId=" + frId + ", frName=" + frName
				+ ", subCatName=" + subCatName + ", soldQty=" + soldQty + ", soldAmt=" + soldAmt + ", varQty=" + varQty
				+ ", varAmt=" + varAmt + ", retQty=" + retQty + ", retAmt=" + retAmt + ", netQty=" + netQty
				+ ", netAmt=" + netAmt + ", retAmtPer=" + retAmtPer + "]";
	}
