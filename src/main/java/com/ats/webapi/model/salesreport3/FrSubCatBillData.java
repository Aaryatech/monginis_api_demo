...
public class FrSubCatBillData {
	...
	public String toString() {
		return "FrSubCatBillData [subCatId=" + subCatId + ", frId=" + frId + ", subCatName=" + subCatName + ", frName="
				+ frName + ", soldQty=" + soldQty + ", soldAmt=" + soldAmt + ", taxableAmt=" + taxableAmt + ", taxAmt="
				+ taxAmt + ", varQty=" + varQty + ", varAmt=" + varAmt + ", varTaxableAmt=" + varTaxableAmt
				+ ", varTaxAmt=" + varTaxAmt + ", retQty=" + retQty + ", retAmt=" + retAmt + ", retTaxableAmt="
				+ retTaxableAmt + ", retTaxAmt=" + retTaxAmt + "]";
	}
