...
public interface GetCurrentBmsStockRepo extends JpaRepository<GetBmsCurrentStock, Integer> {
	...
	/*
	 * @Query(
	 * value=" SELECT m_rm.rm_uom_id, m_rm.rm_id,m_rm.rm_name,COALESCE(s7.bms_opening_stock,0) as bms_opening_stock,COALESCE(s7.bms_opening_stock,0) as bms_closing_stock ,\n"
	 * +
	 ...
	 * 
	 * List<GetBmsCurrentStock> getBmsCurStockForRM(@Param("curDate") Date
	 * curDate,@Param("prodDeptId") int prodDeptId,@Param("mixDeptId") int
	 * mixDeptId,
	 * 
	 ...
	 * 
	 * @Query(
	 * value="SELECT m_rm.rm_uom_id, m_rm.rm_id,m_rm.rm_name,COALESCE(s2.bms_opening_stock,0) as bms_opening_stock ,\n"
	 * +
	 ...
	 * "WHERE m_rm.del_status=0 GROUP BY m_rm.rm_id  ",nativeQuery=true)
	 * 
	 * List<GetBmsCurrentStock> getBmsCurStockForRMBetDate(@Param("fromDate")
	 * java.util.Date fromDate,@Param("toDate") java.util.Date toDate);
	 */
	 ...
	 * 
	 * List<GetBmsCurrentStock> getBmsCurStockForRM(@Param("curDate") Date
	 * curDate,@Param("deptId") int deptId);
	 * 
	 * 
	 * 
	 * 
	 ...
	 * 
	 * List<GetBmsCurrentStock> getBmsCurStockForRMBetDate(@Param("fromDate")
	 * java.util.Date fromDate,@Param("toDate") java.util.Date toDate); //Both
	 * changed
	 */
